...
import {
	AwardHtmlElement,
	CertificateHtmlElement,
	EducationHtmlElement,
	ProjectHtmlElement,
	PublicationHtmlElement,
	VolunteerHtmlElement,
	WorkHtmlElement,
...
import { ReferenceHtmlElement } from "./origin/sidebar/reference";
...
export async function origin(
	...
	async function addBodyItem(html: HTMLElement) {
		...
		try {
			...
			if (last?.id.includes("section-title")) {
	...
	for (const reference of resume.references || []) {
		await addSidebarItem(ReferenceHtmlElement(reference, theme, index).build());
	}
	...
	const sections = [
		{
			...
			generateItem: CertificateHtmlElement,
		},
		{
			title: "Projects",
			...
			generateItem: ProjectHtmlElement,
		},
		{
			title: "Awards",
		...
		},
		{
			...
			generateItem: PublicationHtmlElement,
		},
		{
			...
			generateItem: VolunteerHtmlElement,
		},
		{
			title: "Education",
			...
			generateItem: EducationHtmlElement,
		},
	];
