                            ...
                            <div class="flex items-center justify-center text-white flex-col gap-2 p-4 font-bold bg-${theme.color.secondary}-500 mt-4">
                                ${
																	basics.contact?.email
																		? `
                                    <a href="mailto:${basics.contact.email}" class="text-sm flex items-center justify-center">${basics.contact.email}</a>
                                `
																		: ""
																}
                                ${
																	basics.contact?.phone
																		? `
                                    <a href="tel:${basics.contact.phone}" class="text-sm flex items-center justify-center">${basics.contact.phone}</a>
                                `
																		: ""
																}
                            </div>
