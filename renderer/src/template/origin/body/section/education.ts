...
export const Courses = (courses: Education.Type['courses'] | undefined, { color }: Theme): string => {
...
export function EducationRenderer(
    { institution, area, courses, studyType, startDate, endDate, url, location, score }: Education.Type,
    { color }: Theme,
    index: number
) {
